...
#consequence([При $tau, c gt.eq.slant 0, space b > 0, space a = 1, space n -> oo$ для решения реккурентного соотношения (@t15:eq4) верна асимптотическая оценка: $ t(n) = O(n^(tau + 1)) $])[]

#consequence([При $c gt.eq.slant 0, space b > 0, space a > 1, space t in ZZ_+, space n -> oo$ для решения реккурентного соотношения (@t15:eq4) верна асимптотическая оценка: $ t(n) = O(a^(n slash k)) $])[]