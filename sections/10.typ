...
- К классу $N P$ относятся все задачи, решение которых можно _проверить_ за полиномиальное время. Проверка осуществляется следующим образом:  абстрактная сущность --- оракул --- предлагает решения, которые после проверки верификатором за полиномиальное время приобретают "юридическую" силу
