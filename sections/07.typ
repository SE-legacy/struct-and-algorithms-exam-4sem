...
#definition[*Трудоёмкость алгоритма* --- количество элементарных операций, совершаемых алгоритмом для решения конкретной проблемы, заданной $N + M + S_d + S_r$ словами в памяти, где
